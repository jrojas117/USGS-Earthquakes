// Retrive 2 weeks and a half of earthquake data from USGS
var link = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/2.5_week.geojson"
// Helper functions to magnifie the radio of the data dot
function markerSize(mag) {
  return mag * 30000;
}
// Helper function to define the color of the data dot depending on the magnitud
